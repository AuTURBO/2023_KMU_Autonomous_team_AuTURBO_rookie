...
class ARCurveController(object):
    ...
    def __call__(self, ranges, angle_increment, ar_curve_state_flag, ar_curve_action_flag):
        ...
        if self.ar_curve_state_flag == 1 and self.ar_curve_action_flag == 0:
            return 0, 0, 1, 0
        return  int(steer), 2, self.ar_curve_state_flag, self.ar_curve_action_flag